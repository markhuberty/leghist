...
In order to examine overall trends, \texttt leghist provides an interface to visualize the macro-scale development of a bill in terms of amendment and topic flow. Implementation occurs via the \tttext{igraph} package for R \citep{...}. Two types of acyclic directed graphs are facilitated:
