...
* Thing to note: for the more advanced similarity measure, need to have a term vector that's the union of terms across all documents in bill1 + amendments. That means you need a process like:
